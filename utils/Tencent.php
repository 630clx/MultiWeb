...
class OAuth
{
    ...
    public static function getAccessTokennew($code, $redirect_uri)
    {
        return Http::request(self::getAccessToken($code,$redirect_uri));
    }
...
class Tencentnew
{
     ...
     * @return string
     */
    public static function api($command, $token_openid,$params = array(), $method = 'GET', $multi = false)
    {
        //OAuth 2.0 方式
            //鉴权参数
            $params['access_token'] = $token_openid[0];
            $params['oauth_consumer_key'] = OAuth::$client_id;
            $params['openid'] = $token_openid[1];
            $params['oauth_version'] = '2.a';
            $params['clientip'] = Common::getClientIp();
            $params['scope'] = 'all';
            $params['appfrom'] = 'php-sdk2.0beta';
